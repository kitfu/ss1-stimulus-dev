...
const action = [
    ...
    {
        scenario:
            "Irritated by a noisy neighbourhood dog, a neighbour shoots the dog with an arrow.",
    },
    {
        scenario:
            "At his mother’s funeral, a man wears a t-shirt and shorts although everyone else is informal wear.",
    },
    {
        scenario:
    ...
    {
        scenario:
            "Instead of going to the dressing rooms, a man tries on dress shirts in the centre of the department store.",
    },
    {
        scenario:
            "Just to push his limits, a man wears a colourful skirt to the office for everyone else to see.",
    },
    {
        scenario:
...
const word_count = [41, 47, 35, 58, 100, 98, 86, 47, 52, 46];

// Content Save
const output = `output/wc-${model}/${index}.txt`;
...
for (let i = 0; i < repeat; i++) {
    ...
    const response = await client.responses.create({
        ...
        input: `Instructions: 
                    ...
                    answer the question as directly as possible. Please limit your answer to exactly ${word_count[index - 1]} words.
                `,
        // GPT-4
        temperature: 0,
